...
class CinemaNameMapper implements CinemaNameMapperInterface
{
    public function mapIdToName(CinemaIdEnum $id): string
    {
        return match ($id) {
            ...
            // United Kingdom
            CinemaIdEnum::UK_BACKLOT => 'The Backlot Cinema',
            CinemaIdEnum::UK_ARC => 'The Arc UK',
            CinemaIdEnum::UK_THROWLEY_YARD => 'Throwley Yard Cinema',
            CinemaIdEnum::UK_EARLING_PROJECT => 'Ealing Project',
            CinemaIdEnum::UK_OMNIPLEX => 'Omniplex UK',
            CinemaIdEnum::UK_WATERMANS => 'Watermans Arts Centre',
            CinemaIdEnum::UK_HIGHLIAND => 'Highland Cinema',
            CinemaIdEnum::UK_THE_LIGHT => 'The Light',
            CinemaIdEnum::UK_ODEON => 'Odeon',
            CinemaIdEnum::UK_PERTH_PLAYHOUSE => 'The perth playhouse',
            CinemaIdEnum::UK_SAVOY => 'Savoy cinemas',
            CinemaIdEnum::UK_VUE => 'Vue',
            CinemaIdEnum::UK_SHOWCASE => 'Showcase',
            CinemaIdEnum::UK_CINEWORLD => 'Cineworld',
        };
    }
}