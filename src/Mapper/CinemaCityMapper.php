...
class CinemaCityMapper implements CinemaCityMapperInterface
{
    public function mapIdToCities(CinemaIdEnum $id): array
    {
        return match ($id) {
            ...
            // United Kingdom
            CinemaIdEnum::GB_BACKLOT => ['Blackpool'],
            CinemaIdEnum::GB_ARC => ['Great Yarmouth', 'Daventry', 'Peterhead', 'Beeston'],
            CinemaIdEnum::GB_THROWLEY_YARD => ['Sutton'],
            CinemaIdEnum::GB_EARLING_PROJECT => ['London'],
            CinemaIdEnum::GB_OMNIPLEX => ['Belfast', 'Derry', 'Lisburn', 'Newry', 'Bangor', 'Craigavon'],
            CinemaIdEnum::GB_WATERMANS => ['London'],
            CinemaIdEnum::GB_HIGHLIAND => ['Fort William'],
            CinemaIdEnum::GB_THE_LIGHT => ['Cambridge', 'Sheffield', 'Stockport', 'Bradford', 'Bolton', 'Walsall', 'New Brighton', 'Wisbech', 'Banbury'],
            CinemaIdEnum::GB_ODEON => ['London', 'Manchester', 'Birmingham', 'Glasgow', 'Liverpool', 'Edinburgh', 'Belfast', 'Cardiff', 'Bristol', 'Leeds', 'Sheffield', 'Leicester', 'Brighton', 'Southampton', 'Newcastle upon Tyne'],
            CinemaIdEnum::GB_PERTH_PLAYHOUSE => ['Perth'],
            CinemaIdEnum::GB_SAVOY => ['Nottingham', 'Doncaster', 'Boston', 'Worksop', 'Corby', 'Grantham'],
            CinemaIdEnum::GB_VUE => ['London', 'Manchester', 'Bristol', 'Edinburgh', 'Leeds', 'Cardiff', 'Birmingham', 'Glasgow', 'Sheffield', 'Aberdeen', 'Cambridge', 'Exeter', 'Oxford', 'Portsmouth', 'York'],
            CinemaIdEnum::GB_SHOWCASE => ['London', 'Bristol', 'Glasgow', 'Leicester', 'Reading', 'Leeds', 'Nottingham', 'Derby', 'Peterborough', 'Coventry', 'Cardiff', 'Southampton'],
            CinemaIdEnum::GB_CINEWORLD => ['London', 'Glasgow', 'Birmingham', 'Edinburgh', 'Sheffield', 'Cardiff', 'Manchester', 'Bristol', 'Belfast', 'Aberdeen', 'Nottingham', 'Liverpool', 'Leeds', 'Newcastle upon Tyne'],
        };
    }
}