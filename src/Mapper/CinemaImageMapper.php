...
class CinemaImageMapper implements CinemaImageMapperInterface
{
    public function mapIdToImageUrl(CinemaIdEnum $id): ?string
    {
        return match ($id) {
            ...
            // United Kingdom
            CinemaIdEnum::UK_BACKLOT => 'https://indy-systems.imgix.net/zwebgxpekbr27lnp185yaugovq2e?w=400&auto=format',
            CinemaIdEnum::UK_ARC => 'https://greatyarmouth.arccinema.co.uk/assets/images/logo_large.png',
            CinemaIdEnum::UK_THROWLEY_YARD => 'https://indy-systems.imgix.net/wdcofoosr8yuqcbw4ygxyehw3lqu?w=1200&auto=format',
            CinemaIdEnum::UK_EARLING_PROJECT => 'https://indy-systems.imgix.net/dok5cwkie8nnr94x58hl49cpv2uy?w=1200&auto=format',
            CinemaIdEnum::UK_OMNIPLEX => 'https://www.omniplex.ie/images/omniplex_logo.svg',
            CinemaIdEnum::UK_WATERMANS => 'https://www.watermans.org.uk/wp-content/themes/watermans/img/global/logo.png',
            CinemaIdEnum::UK_HIGHLIAND => 'https://highlandcinema.co.uk/wp-content/uploads/2020/09/HC-Landscape-Black-Animated-scaled-2.gif',
            CinemaIdEnum::UK_THE_LIGHT => 'https://thelight.co.uk/img/logo-white.svg',
            CinemaIdEnum::UK_ODEON => "https://www.odeon.co.uk/media/ehgpomhe/odeon-logo-web.svg",
            CinemaIdEnum::UK_PERTH_PLAYHOUSE => "https://indy-systems.imgix.net/2rspj73jxtch2h7ny22atgvflr1t?w=400&auto=format",
            CinemaIdEnum::UK_SAVOY => 'https://images.savoysystems.co.uk/SVN/38746823.jpg',
            CinemaIdEnum::UK_VUE => 'https://www.myvue.com/-/jssmedia/global/img/logo-header-vue.png?mw=300&mh=80&rev=5d978a6ad9c04cac97869073febdf5c4',
            CinemaIdEnum::UK_SHOWCASE => 'https://cms-assets.webediamovies.pro/cdn-cgi/image/dpr=1,fit=crop,format=webp,gravity=auto,metadata=none,quality=85,width=500,height=138/production/4756/e8bc079fc984897dec24fc94fe83eafb.png',
            CinemaIdEnum::UK_CINEWORLD => 'https://www.cineworld.co.uk/mrest/logos/v1/10108/logo.svg',
        };
    }
}