...
class CinemaImageMapper implements CinemaImageMapperInterface
{
    public function mapIdToImageUrl(CinemaIdEnum $id): string
    {
        $fileName = match ($id) {
            ...
            // Poland
            CinemaIdEnum::PL_NOVEKINO => 'novekino.png',
            CinemaIdEnum::PL_KINO_STYLOWY => 'kino-stylowy.png',
            CinemaIdEnum::PL_KINO_SOKOL => 'kino-sokol.png',
            CinemaIdEnum::PL_KINO_KIJOW => 'kino-kijow.png',
            CinemaIdEnum::PL_KINO_ZORZA => 'kino-zorza.png',
            CinemaIdEnum::PL_KINO_BAJKA => 'kino-bajka-2.png',
            CinemaIdEnum::PL_CINEMA_LUMIERE => 'cinema-lumiere.png',
            CinemaIdEnum::PL_KINO_STUDYJNE_AWANGARDA => 'kino-studyjne-awangarda.png',
            CinemaIdEnum::PL_KINO_JANTAR => 'kino-jantar.png',
            CinemaIdEnum::PL_KINO_TON => 'kino-ton.png',
            CinemaIdEnum::PL_KINO_WIELICKA_MEDIATEKA => 'kino-wielecka-mediateka.png',
            CinemaIdEnum::PL_KINO_MALTA => 'kino-malta.png',
            CinemaIdEnum::PL_KINO_MILLENNIUM => 'kino-millenium.png',
            CinemaIdEnum::PL_KINO_CENTRUM => 'kino-centrum.png',
            CinemaIdEnum::PL_KINO_MOK => 'kino-mok.png',
            CinemaIdEnum::PL_KINO_WCK => 'kino-wck.png',
            CinemaIdEnum::PL_KINO_NARIE => 'kino-narie.png',
            CinemaIdEnum::PL_PYRZYCKI_DOM_KULTURY => 'pyrzycki-dom-kultury.png',
            CinemaIdEnum::PL_KINO_WYBRZEZE => 'kino-wybrzeze.png',
            CinemaIdEnum::PL_KINO_OPOLANKA => 'kino-opolanka.png',
            CinemaIdEnum::PL_KINO_CISY => 'kino-cisy.png',
            CinemaIdEnum::PL_KINO_JUTRZENKA => 'kino-jutrzenka.png',
            CinemaIdEnum::PL_KINO_ZBYSZEK => 'kino-zbyszek.png',
            CinemaIdEnum::PL_KINO_MOSKWA => 'kino-moskwa.png',
            CinemaIdEnum::PL_KINO_KOLORY => 'kino-kolory.png',
            CinemaIdEnum::PL_KINO_LUBON => 'kino-lubon.png',
            CinemaIdEnum::PL_KINO_BAJKA_KLUCZBORK => 'kino-bajka.png',
            CinemaIdEnum::PL_KINO_SNIEZKA => 'kino-sniezka.png',
            CinemaIdEnum::PL_MCK_LEZAJSK => 'mck-lezajsk.png',
            CinemaIdEnum::PL_CINEMA_CITY => 'cinema-city.png',
            CinemaIdEnum::PL_KINO_TOMI => 'kino-tomi.png',
            CinemaIdEnum::PL_KINO_DIANA => 'kino-diana.png',
            CinemaIdEnum::PL_KINO_PATRIA => 'kino-patria.png',
            CinemaIdEnum::PL_KINO_ZACISZE => 'kino-zacisze.png',
        };
